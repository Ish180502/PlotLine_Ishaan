                        ...
                        <div className="row p-2 gx-2">
                            ...
                            <div className="col-12 col-md-6 position-relative border rounded p-2">
                                ...
                                <ul class="list-unstyled mb-1 my-3 my-md-0">
                                    ...
                                    <li class="d-flex justify-content-between py-1 border-bottom"><strong class="text-muted">Taxes(SA+SB+SC)</strong><span>₹{(orderData.servicesPrice>1000 && orderData.servicesPrice<=8000?(15/100)*orderData.servicesPrice : 0)+(orderData.servicesPrice>8000? (12/100)*orderData.servicesPrice:0)+100}</span></li>
                                    <li class="d-flex justify-content-between py-1 border-bottom"><strong class="">Total</strong>
                                        <strong class="font-weight-bold">₹{(orderData.servicesPrice>1000 && orderData.servicesPrice<=8000?(15/100)*orderData.servicesPrice : 0)+(orderData.servicesPrice>8000? (12/100)*orderData.servicesPrice:0)+100+orderData.servicesPrice}</strong>
                                    </li>
                                </ul>
