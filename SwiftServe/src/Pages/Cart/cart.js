...
const CartItemCard = (props) => {
    ...
    return (
        ...
        <div class="card mb-2">
            ...
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="./cartImage.png" class="img-fluid rounded-start" alt="..." />
                </div>
                <div class="col-md-8">
                    <div class="card-body ">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
                                <h2>Cart</h2>
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">To increase cart value and add more services
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <ul class="list-unstyled mb-4">
                                            ...
                                            class="text-muted">SA</strong><strong>₹{subTotal>1000 && subTotal<=8000?(15/100)*subTotal : 0}</strong></li>
                                            <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">SB</strong><strong>₹{subTotal>8000? (12/100)*subTotal:0}</strong></li>
                                            <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">SC</strong><strong>₹100</strong></li>
                                            <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Total</strong>
                                                <h5 class="font-weight-bold">₹{(subTotal>1000 && subTotal<=8000?(15/100)*subTotal : 0)+(subTotal>8000? (12/100)*subTotal:0)+100+subTotal}</h5>
                                            </li>
                                        </ul>
