...
const Footer = () => {
    ...
    return (
        ...
        <footer id="main-footer" class=" bottom-0 start-0 py-2 py-md-5 container-fluid" style={{ backgroundColor: "#fff" }}>
            <div class="row">
                <div class="col-12 col-md-4 py-2 py-md-0">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2 p-0 text-muted">Patiala,Punjab</li>
            ...
            <div class="d-flex justify-content-between align-items-center py-4 my-4 border-top h-25">
                <div className="d-flex align-items-center">
                    <img className="d-inline-block mx-2" width="40" height="40" src="./logo192.png" alt="logo" />
                    <p className="m-0">&copy; 2023 SwiftServe, Inc. All rights reserved.</p>
                </div>
                <ul class="list-unstyled d-flex">
                    <li class="ms-3 fs-3"><a class="link-dark p-0" href="https://www.instagram.com/ig.ishmusic/"><FaInstagram /></a></li>
